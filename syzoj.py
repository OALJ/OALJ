...
if __name__ == '__main__':
    if len(sys.argv) == 2:
        ...
        id = (input('请输入题目编号(syzoj): '))
    Url = "https://syzoj.com/problem/" + id
    DataUrl = "https://syzoj.com/problem/{0}/testdata".format(id)
    ...
    os.system("cd data")
    print("正在下载数据包...")
    os.system("axel -a -o {0}.zip  https://syzoj.com/problem/{0}/testdata/download".format(id))
    print("下载完成...正在解压数据包...")
    ...
    print("配置文件生成完成啦，由于syzoj公开data_rule，然而由于我懒得解析，自动生成的config可能会存在问题，请谨慎使用qwq")
